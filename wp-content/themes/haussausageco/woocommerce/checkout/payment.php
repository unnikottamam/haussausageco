...
<div id="payment" class="woocommerce-checkout-payment">
    ...
    <div class="form-row place-order">
        <noscript>
            ...
            <br />
            <button type="submit" class="btn btn-sm btn-outline-primary button alt"
        ...
        <?php echo apply_filters(
          ...
          '<button type="submit" class="btn btn-sm btn-outline-primary button alt" name="woocommerce_checkout_place_order" id="place_order" value="' .
