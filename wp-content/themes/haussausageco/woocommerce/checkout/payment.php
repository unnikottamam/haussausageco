...
<div id="payment" class="woocommerce-checkout-payment payment_gateways">
    ...
    <div class="form-row place-order">
        <noscript>
            ...
            <br /><button type="submit" class="button alt btn btn-sm btn-outline-primary"
  ...
  'woocommerce'
        ...
        <?php echo apply_filters(
          ...
          '<button type="submit" class="button alt btn btn-sm btn-outline-primary" name="woocommerce_checkout_place_order" id="place_order" value="' .
