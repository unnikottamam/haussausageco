...
<form id="add_payment_method" method="post">
  ...
  $gateway->id
                    ...
                    <label class="custom-control-label" for="payment_method_<?php echo esc_attr(
                      $gateway->id
                    ); ?>">
        ...
        <div class="form-group">
            ...
            <button type="submit" class="woocommerce-Button woocommerce-Button--alt button alt btn btn-outline-primary btn-sm"
